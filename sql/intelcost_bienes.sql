...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-08-2020 a las 04:43:59
...
CREATE TABLE `bienes` (
  ...
  `Precio` varchar(15) COLLATE utf8_spanish2_ci NOT NULL
...
(13, 'P.O. Box 466, 2795 Velit. Aven', 'New York', '252-330-0116', '5422', 'Apartamento', '$78,947'),
...
(38, 'P.O. Box 825, 9762 Etiam Stree', 'Miami', '343-695-3228', '56309', 'Casa de Campo', '$42,579'),
...
(47, 'P.O. Box 926, 1798 Pellentesqu', 'New York', '328-063-3034', '0547ID', 'Casa', '$48,882'),
(48, 'P.O. Box 264, 6488 Euismod Ave', 'Los Angeles', '210-220-4305', 'J6H 9S9', 'Apartamento', '$33,141'),
...
(60, 'P.O. Box 870, 9855 Tristique A', 'Miami', '114-453-9481', '64899', 'Casa', '$67,772'),
...
(89, 'P.O. Box 556, 1951 Vulputate A', 'Houston', '670-572-1780', '4484KP', 'Casa', '$95,859'),
...
(92, 'P.O. Box 519, 981 Nostra, Aven', 'Miami', '440-469-6769', '61790-368', 'Casa de Campo', '$49,957'),
...
(96, 'P.O. Box 169, 7235 Quisque Roa', 'Los Angeles', '782-078-8565', '86541', 'Casa', '$39,721'),
...
INSERT INTO `misbienes` (`Id`, `id_bienes`) VALUES
(1, 29);
...
ALTER TABLE `misbienes`
  ADD UNIQUE KEY `id_bienes` (`id_bienes`);
...
--
-- Filtros para la tabla `misbienes`
--
ALTER TABLE `misbienes`
  ADD CONSTRAINT `misbienes_ibfk_1` FOREIGN KEY (`id_bienes`) REFERENCES `bienes` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
